...
import 'ai_tool_card5_model.dart';
export 'ai_tool_card5_model.dart';
...
class AiToolCard5Widget extends StatefulWidget {
  const AiToolCard5Widget({super.key});

  @override
  State<AiToolCard5Widget> createState() => _AiToolCard5WidgetState();
}

class _AiToolCard5WidgetState extends State<AiToolCard5Widget> {
  late AiToolCard5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AiToolCard5Model());
  }
                ...
                child: Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      '3zwlurnv' /* Improve Photo Quality */,
                    ),
