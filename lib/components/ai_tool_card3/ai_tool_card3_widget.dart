...
import 'ai_tool_card3_model.dart';
export 'ai_tool_card3_model.dart';
...
class AiToolCard3Widget extends StatefulWidget {
  const AiToolCard3Widget({super.key});

  @override
  State<AiToolCard3Widget> createState() => _AiToolCard3WidgetState();
}

class _AiToolCard3WidgetState extends State<AiToolCard3Widget> {
  late AiToolCard3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AiToolCard3Model());
  }
                ...
                child: Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'kngxo16l' /* Improve Photo Quality */,
                    ),
