...
import 'ai_tool_card4_model.dart';
export 'ai_tool_card4_model.dart';
...
class AiToolCard4Widget extends StatefulWidget {
  const AiToolCard4Widget({super.key});

  @override
  State<AiToolCard4Widget> createState() => _AiToolCard4WidgetState();
}

class _AiToolCard4WidgetState extends State<AiToolCard4Widget> {
  late AiToolCard4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AiToolCard4Model());
  }
